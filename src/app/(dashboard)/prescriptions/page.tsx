...
import { getPrescriptionStats, listPrescriptions } from '@/lib/prescriptions/prescription-service'
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage customer prescriptions and dispensing records
          </p>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button asChild variant="outline">
            <Link href={ROUTES.PRESCRIPTIONS_PENDING}>Pending Review ({stats.pending})</Link>
          </Button>
          <Button asChild>
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <Card>
          <CardHeader className="py-3">
            <CardTitle className="text-sm font-medium text-blue-600">Dispensed</CardTitle>
          </CardHeader>
          <CardContent className="py-0 pb-3">
      ...
      <PrescriptionsView initialRows={initialRows} initialPagination={firstPage.pagination} />
    </div>
  )
}
